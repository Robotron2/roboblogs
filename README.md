...
RoboBlogs is a state-of-the-art blogging platform designed for creators who value both high-end design and a powerful writing experience. With a focus on sleek aesthetics and robust performance, RoboBlogs bridges the gap between simple blogging and professional content management.
...
2. **Configure Your Environment**
   - Head into both the `client` and `server` folders and fill in the `.env` files with your specific settings (like your database link and image upload keys).
...
4. **Visit the Site**
   Go to `http://localhost:5173` in your browser and start blogging!
...
- **Frontend**: Built with **React** and **TailwindCSS** for a responsive and beautiful interface.
- **Backend**: A robust **Node.js** and **Express** server handling all the heavy lifting.
- **Database**: **MongoDB** for flexible and reliable data storage.
- **Editor**: **TipTap** engine for an intuitive writing experience.
- **Design**: **Lucide React** for crisp, modern iconography.
